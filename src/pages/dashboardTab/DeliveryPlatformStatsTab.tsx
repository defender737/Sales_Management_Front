...
export default function DeliveryPlatformStatsTab({year, isExcludeDeliveryFee}: DeliveryPlatformStatsTab) {
    ...
    const [commissionData, setCommissionData] = useState<number[]>([]);
    ...
    const { request, loading } = useApiRequest(
        ...
        (response) => {
            ...
            const deliveryCommissionMap = response.data.deliveryCommissionSummary || {};
            ...
            setCommissionData(getValues(deliveryCommissionMap));
