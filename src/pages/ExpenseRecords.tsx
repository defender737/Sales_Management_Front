...
const ExpenseColumns = [
  ...
  { key: "date", label: "날짜", width: "20%" },
  { key: "amount", label: "금액", width: "20%" },
    ...
    <Box>
      ...
      <Container sx={{
        ...
        {isLoading ? (
          ...
          <>
            <Table<ResponseExpenseRecord> data={data} columns={ExpenseColumns} keyExtractor={(item) => item.id} onRowClick={handleRowClick} />
